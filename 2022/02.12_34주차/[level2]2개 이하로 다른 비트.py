...
# 예를 들어,
# f(2) = 3 입니다. 다음 표와 같이 2보다 큰 수들 중에서 비트가 다른 지점이 
# 2개 이하이면서 제일 작은 수가 3이기 때문입니다.
# 수	비트	    다른 비트의 개수
# 2	    000...0010	
# 3	    000...0011	    1
# f(7) = 11 입니다. 다음 표와 같이 7보다 큰 수들 중에서 비트가 다른 지점이 
# 2개 이하이면서 제일 작은 수가 11이기 때문입니다.
# 수	비트	    다른 비트의 개수
# 7	    000...0111	
# 8	    000...1000	    4
# 9	    000...1001	    3
...
# [문제접근]
# 입력받은 수를 2진수로 변환하고 (bin함수) 값을 1씩 증가시켜
# 비트의 수를 계산하면 될듯하다.
